...
def savefile() :
    f = asksaveasfile(mode= "w", defaultextension=".txt", filetypes=[('textfile', '.txt')])
...
menu_1.add_command(label="새 파일", command=newfile)
menu_1.add_command(label="저장", command=savefile)
